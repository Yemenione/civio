...
<template>
    <GuestLayout>
        <Head title="Log in — Civio" />

        <!-- Title -->
        <div class="mb-7 text-center">
            <h1 class="text-2xl font-bold text-white">Welcome back 👋</h1>
            <p class="text-slate-400 mt-1 text-sm">Sign in to your Civio account</p>
        </div>

        <div v-if="status" class="mb-4 text-sm font-medium text-green-400 bg-green-500/10 border border-green-500/20 rounded-lg px-4 py-2">
            {{ status }}
        </div>
